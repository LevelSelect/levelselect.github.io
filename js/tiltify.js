...
function tiltPull() {
    fetch("https://dftbrt-cors.herokuapp.com/https://api.tiltify.com/", {
        ...
        "body": "{\"operationName\":\"get_campaign_and_milestones\",\"variables\":{\"vanity\":\"+levelselect\",\"slug\":\"autumn-charity-select\"},\"query\":\"query get_campaign_and_milestones($vanity: String!, $slug: String!) {\\n  campaign(vanity: $vanity, slug: $slug) {\\n    id\\n    name\\n    status\\n    topDonation {\\n      amount {\\n        currency\\n        value\\n        __typename\\n      }\\n      donorName\\n      id\\n      __typename\\n    }\\n    totalAmountRaised {\\n      value\\n      currency\\n      __typename\\n    }\\n    goal {\\n      value\\n      currency\\n      __typename\\n    }\\n    milestones {\\n      id\\n      name\\n      amount {\\n        value\\n        currency\\n        __typename\\n      }\\n      __typename\\n    }\\n    cause {\\n      name\\n      avatar {\\n        alt\\n        src\\n        __typename\\n      }\\n      colors {\\n        highlight\\n        background\\n        __typename\\n      }\\n      __typename\\n    }\\n    fundraisingEvent {\\n      name\\n      avatar {\\n        alt\\n        src\\n        __typename\\n      }\\n      colors {\\n        highlight\\n        background\\n        __typename\\n      }\\n      __typename\\n    }\\n    __typename\\n  }\\n}\\n\"}",
        "method": "POST"
    })
